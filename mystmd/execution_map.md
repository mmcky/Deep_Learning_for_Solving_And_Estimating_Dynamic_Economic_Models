...
**Reproducibility.** Random-seed conventions, the budget split, hardware and software pins, and GPU-determinism flags used by every notebook in the table above are documented in Appendix {ref}`app-reproducibility`. Worked solutions and guidance for the end-of-chapter exercises are collected in Appendix {ref}`app-solutions`.
