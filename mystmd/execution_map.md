...
* - 2
  ...
  - L03: `02_DEQNs`; L07: `05b_AutoDiff`
  - L03 `01`--`02` (c), `03`--`04` (e/s), `05` (c); L07 `01`--`04` (c)
* - 3
  - IRBC Model
  - L04: `03_IRBC`
  - L04 `01`--`02` (c)
...
* - 6
  - HA, Young, Seq. Space
  - L09: `09_HA_Young`; L10: `10_SeqSpace`
  - L09 `10`--`12` (c); L10 `05`, `05b`, `06` (c), `KrusellSmith_Tutorial_CPU` (x)
* - 7
  - PINNs
  - L11: `06_PINNs`
  - L11 `01`--`05` (c)
* - 8
  - CT Het. Agents
  - L12: `07_CT_Theory`; L13: `08_CT_Num`
  - L13 `06`--`08` (c), `09` (e)
* - 9
  - Surrogates, GPs, DKL
...
* - 11
  ...
  - L16 `01`--`03` (c); L17 `09_DICE_2P_UQ_Analysis` (c) plus 4 `.py` pipeline drivers
* - 12
  - Synthesis & Outlook
  - L18: `10_Wrap_Up`
  - ---
