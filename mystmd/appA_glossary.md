...
\textbf{Bayesian active learning (BAL).}
...
\textbf{Common random numbers (CRN).}
...
\textbf{Deep Equilibrium Net (DEQN).}
...
\textbf{Deep Galerkin Method (DGM).}
...
\textbf{Gauss--Hermite quadrature.}
...
\textbf{Kolmogorov forward equation (KFE / Fokker--Planck).}
...
\textbf{Physics-Informed Neural Network (PINN).}
...
\textbf{Social cost of carbon (SCC).}
...
\textbf{Value Function Iteration (VFI).}
