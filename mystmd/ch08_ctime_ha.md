...
4.   **[Computational\] HJB residual.** In notebook , compute the maximum HJB residual on a 50-point test grid after a fixed PINN training budget. Repeat with a larger collocation batch and report the actual scaling you observe.
