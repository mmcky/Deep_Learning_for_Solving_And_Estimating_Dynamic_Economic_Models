...
## 1. Headline result (Round 12)

Upstream pin: `43565a4` (unchanged from R11). R12 is a **fidelity walkthrough** rather than another upstream bump — comparing source LaTeX to MyST markdown chapter-by-chapter to catch any content drops that the structural validator was blind to.
