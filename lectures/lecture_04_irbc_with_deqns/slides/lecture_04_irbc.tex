...
\begin{enumerate}
    ...
    \item Open notebook \texttt{lecture\_04\_01\_IRBC\_DEQN\_smooth.ipynb}, change $\delta$, and verify your prediction.
\end{enumerate}
\end{exampleblock}
\end{frame}
...
\begin{enumerate}\itemsep1pt
    \item \texttt{lecture\_04\_01\_IRBC\_DEQN\_smooth.ipynb} -- \emph{smooth benchmark, in-class walk-through (this lecture's \texttt{code/})}
    \begin{itemize}\itemsep0pt
    ...
    \item \texttt{lecture\_04\_02\_IRBC\_DEQN\_irreversible.ipynb} -- \emph{irreversible-investment extension (this lecture's \texttt{code/})}
    \begin{itemize}\itemsep0pt
    ...
    \item \texttt{lecture\_05\_05\_IRBC\_Exercise.ipynb} -- \emph{hands-on exercise (lives in L05's \texttt{code/})}
    \begin{itemize}\itemsep0pt
...
OLG $\to$ Heterogeneous Agents (Young's method)}\\[12pt]
\end{center}
\end{columns}
\end{frame}
